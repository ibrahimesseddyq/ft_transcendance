...
export function QuizPage() {
    ...
    return (
        <div className="overflow-y-auto no-scrollbar items-center w-full h-[calc(100vh-80px)]
            bg-surface-main dark:bg-slate-950 rounded-xl transition-colors duration-300">
            <ToastContainer />
                ...
                <div className="flex flex-wrap col-span-4 lg:col-span-3 h-full w-full
                    ...
                    <div className='items-stretch flex flex-col gap-4 h-full w-full p-4 lg:p-8 overflow-y-auto custom-scrollbar'>
                        ...
                        <div className='flex gap-2 p-1 bg-slate-100 dark:bg-slate-800 rounded-xl w-fit'>
                            <button onClick={() => setActiveTab('mcq')}
                                className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all
                                    ${activeTab === 'mcq'
                                        ? 'bg-surface-main dark:bg-secondary-darkbg text-primary shadow-sm'
                        ...
                        {activeTab === 'mcq' ? (
                            <>
                                <div className="mb-2">
                                    <h2 className="text-2xl font-bold text-black dark:text-surface-main">Create New MCQ</h2>
                            ...
                            <>
                                <div className="mb-2">
                                    <h2 className="text-2xl font-bold text-black dark:text-surface-main">Bundle MCQs into a Test</h2>
