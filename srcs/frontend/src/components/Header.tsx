  ...
  return (
    <header className="mx-auto flex justify-between h-16 w-full md:rounded-xl max-w-screen-2xl items-center px-4 md:px-8 
      ...
      >
        ...
        />
        <h1 className="text-sm md:text-md text-center p-2 sm:flex hidden text-black dark:text-surface-main transition-colors">
          RH-<span className="text-primary font-bold">Connect</span>
        </h1>
      </Link>
