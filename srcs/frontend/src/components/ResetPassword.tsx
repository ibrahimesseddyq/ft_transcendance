        ...
        return(
            <div className="p-5 flex flex-col w-full h-full gap-10 items-center justify-center  ">
                ...
                <div className='flex flex-col gap-1 items-center '>
                    ...
                    <h1 className='font-light text-white text-lg'>Enter the 6-digit code sent to you email. This code is valid for the next 10 minutes</h1>
                </div>
                <form action="/" method="" className='w-full flex flex-col gap-10'>
                    ...
                    <div className='flex flex-col gap-2 items-center'>
                        <button type='submit' className='w-full h-14 bg-[#44BC19] rounded-lg font-extrabold text-white'>Reset password</button>
