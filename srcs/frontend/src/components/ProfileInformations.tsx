...
export function ProfileInformations() {
  ...
  console.log("profile?.user?.avatarUrl :", profile?.user?.avatarUrl);
  ...
  console.log("profile?.availableFrom :", profile);
        ...
        <section className="flex flex-col gap-6">
          ...
          <label 
            className={`flex flex-col items-center justify-center w-full h-32 cursor-pointer
              ...
              ${errors.resumeUrl ? 'border-red-500' : 'border-gray-300 dark:border-gray-700 hover:border-[#00adef]'}`}>
